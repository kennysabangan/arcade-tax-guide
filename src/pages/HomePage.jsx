  ...
  return (
    <section className="relative flex flex-col overflow-x-hidden pt-16 min-h-[70vh] sm:min-h-[80vh] lg:min-h-[85vh]">
      ...
      <div className="relative z-20 flex-1 flex flex-col items-center justify-center text-center px-5 py-4 sm:py-6 landscape:py-2">
        ...
        <h1 className="font-heading font-bold leading-[1.1] mb-4 sm:mb-6 lg:mb-8 landscape:mb-2 landscape:text-xl text-3xl sm:text-5xl lg:text-6xl xl:text-7xl">
        ...
        <p className="text-cream-70 text-base sm:text-xl lg:text-3xl xl:text-4xl landscape:text-lg max-w-md sm:max-w-2xl lg:max-w-4xl mx-auto landscape:mb-2 leading-relaxed">
