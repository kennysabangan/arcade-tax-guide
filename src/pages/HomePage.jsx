  ...
  return (
    <section className="relative flex flex-col overflow-x-hidden pt-16 min-h-[70vh] sm:min-h-[80vh] lg:min-h-[85vh]">
      ...
      <div className="relative z-20 flex-1 flex flex-col items-center justify-center text-center px-5 py-4 sm:py-6 landscape:py-2">
        ...
        <p className="text-cream-70 text-sm sm:text-lg lg:text-[1.65rem] landscape:text-sm max-w-xs sm:max-w-2xl lg:max-w-4xl mx-auto mb-4 sm:mb-8 lg:mb-10 landscape:mb-2 leading-relaxed">
        ...
        <div className="mb-4 sm:mb-8 lg:mb-10 landscape:mb-2">
          <CTAButton
            href="#book-a-call"
            className="inline-flex items-center justify-center px-10 sm:px-14 lg:px-16 py-4 sm:py-6 lg:py-5 text-xl sm:text-2xl lg:text-[1.65rem] landscape:text-sm landscape:px-4 landscape:py-2 font-heading font-bold rounded-sm bg-gold text-dark hover:bg-gold/90 hover:shadow-[0_0_32px_rgba(219,177,85,0.6)] active:scale-[0.98] transition-all duration-200"
          >
        ...
        <div className="flex flex-row items-center justify-center gap-2 sm:gap-3 lg:gap-4 mb-4 sm:mb-8 lg:mb-10 landscape:mb-2">
          <CTAButton to="/tax-guide" variant="outline" className="text-xs sm:text-base lg:text-[1.1rem] landscape:text-xs landscape:px-2 landscape:py-1.5 px-2.5 sm:px-6 lg:px-8 py-1.5 sm:py-3 lg:py-3.5">Explore the Tax Guide</CTAButton>
          <CTAButton to="/retirement" variant="outline" className="text-xs sm:text-base lg:text-[1.1rem] landscape:text-xs landscape:px-2 landscape:py-1.5 px-2.5 sm:px-6 lg:px-8 py-1.5 sm:py-3 lg:py-3.5">Retire with Arcade Games</CTAButton>
        </div>
        ...
        <div className="flex items-center justify-center gap-6 sm:gap-10 lg:gap-16 border-t border-gold-20 pt-2 sm:pt-3 lg:pt-4 w-full max-w-xs sm:max-w-sm lg:max-w-lg">
          {stats.map((s, i) => (
            <div key={i} className="text-center">
              <div
                className="font-bold text-xl sm:text-2xl lg:text-4xl landscape:text-sm leading-none mb-1"
