  ...
  return (
    <section className="relative flex flex-col overflow-x-hidden pt-16 min-h-[70vh] sm:min-h-[80vh] lg:min-h-[85vh]">
      ...
      <div className="relative z-20 flex-1 flex flex-col items-center justify-center text-center px-5 py-4 sm:py-6 landscape:py-2">
        ...
        <p className="text-cream-70 text-sm sm:text-lg lg:text-[2.8rem] xl:text-[3.2rem] 2xl:text-[3.6rem] landscape:text-sm max-w-xs sm:max-w-2xl lg:max-w-3xl mx-auto mb-4 sm:mb-8 lg:mb-10 landscape:mb-2 leading-relaxed">
        ...
        <div className="flex flex-row items-center justify-center gap-2 sm:gap-3 lg:gap-4 mt-6 sm:mt-10 lg:mt-12 mb-6 sm:mb-10 lg:mb-14 landscape:mb-2">
